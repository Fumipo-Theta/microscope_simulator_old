...
export const LayersIcon: React.FC<Props> = ({ isActive }) => {
    ...
    const outlineWithFillStyle = { ...outlineWithFillStyleBase, stroke: strokeColor, fill: strokeColor }
    return <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="48" height="48" viewBox="0 0 48 48" xmlSpace="preserve">
        ...
        <g transform="matrix(0.12 0.12 -0.12 0.12 23.92 31.68)" id="F9nnw24s43HqflCPJTG7A"  >
            <path style={outlineWithFillStyle} vectorEffect="non-scaling-stroke" transform=" translate(0, 0)" d={outline} strokeLinecap="round" />
        </g>
        <g transform="matrix(0.12 0.12 -0.12 0.12 23.92 25.09)" id="aUnAAgr4QtdcRSDhx6OTq"  >
            <path style={outlineStyle} vectorEffect="non-scaling-stroke" transform=" translate(0, 0)" d={outline} strokeLinecap="round" />
        </g>
        <g transform="matrix(0.12 0.12 -0.12 0.12 23.92 18.4)" id="ZHy9ixs5wSE218Hy4jojY"  >
            <path style={outlineStyle} vectorEffect="non-scaling-stroke" transform=" translate(0, 0)" d={outline} strokeLinecap="round" />
        </g>
    </svg>
}