...
export default async function checkSupportedImageFormat(state: RootState): Promise<RootState> {
    state.viewerState.supportedImageType = await getSupportedImageType();
    return state
}
