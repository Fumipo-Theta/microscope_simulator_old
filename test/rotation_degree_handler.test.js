...
describe("stepBy", () => {
    test("should return quotient", () => {
        ...
        ].forEach(({ query: { unit, rotation }, expected }) => {
...
describe("cycleBy", () => {
    test("should return residue by positive number", () => {
        [
...
describe("mirrorBy", () => {
    test("should return number having the same distance from the center if the value is larger than the center", () => {
        [
        ...
        ].forEach(({ query: { center, value }, expected }) => {
